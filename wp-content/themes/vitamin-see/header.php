...
<body <?php body_class(); ?>>
<div class="top-Line">
	<div class="outer_wrap texture"></div>
      <div class="header-logo">
        <img src="<?php echo get_theme_mod('header_logo'); ?>" alt="<?php bloginfo('description'); ?>" width="160" height="105" />
        </div>
</div>
<div class="clear"></div>
<?php if(is_front_page()):?>
<div class="outer_wrap texture mainBg">
