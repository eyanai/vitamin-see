...
add_action( 'after_setup_theme', 'simonwpframework_setup' );
 ...
 wp_register_script( 'my-popup-script',  get_template_directory_uri().'/js/popup.js', array('jquery'), '1.0.0', true );
  wp_enqueue_script( 'my-popup-script' );
...
function vitamin_castoum( $wp_customize ) {
   
   $wp_customize->add_section( 'vitamin-castoum' , array(
    'title'      => 'הגדרות כלליות',
    'priority'   => 30,
	));
	...
	'label'        =>'Logo',
	'section'    => 'vitamin-castoum',
	'settings'   => 'header_logo',
	)));
   
   
}
add_action( 'customize_register', 'vitamin_castoum' );